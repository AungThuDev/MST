...
<head>
    ...
    <!-- owl carousel default theme min css -->
    <link rel="stylesheet"
...
<body>
                    ...
                    <div class="offcanvas-body">
                        <ul class="navbar-nav justify-content-end flex-grow-1 pe-3 gap-3">
                            ...
                            <li class="nav-item dropdown">
                                <a class="nav-link dropdown-toggle text-white" href="/programmes" role="button"
                                    data-bs-toggle="dropdown" aria-expanded="false">
                                    Programmes
                                </a>
                                <ul class="dropdown-menu bg-white">
                                    <li><a class="dropdown-item dropdowns text-dark"
                                            onclick="navigateToPage('academics.html#pg')"
                                            href="#">Postgraduate</a></li>
                                    <li><a class="dropdown-item dropdowns text-dark"
                                            onclick="navigateToPage('academics.html#ug')"
                                            href="#">Undergraduate</a></li>
                                    <li><a class="dropdown-item dropdowns text-dark"
                                            onclick="navigateToPage('academics.html#dp')" href="#">Diplomas</a>
                                    </li>
                                    <li><a class="dropdown-item dropdowns text-dark"
                                            onclick="navigateToPage('academics.html#cf')"
                                            href="#">Certifications</a></li>
                                    <li><a class="dropdown-item dropdowns text-dark"
                                            onclick="navigateToPage('academics.html#sc')" href="#">Short
                                            Courses</a></li>
                                </ul>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white" aria-current="page" href="lecturer.html">Faculty</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white" aria-current="page" href="events.html">Events</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link text-white" aria-current="page" href="faq.html">FAQ</a>
                            </li>
                            <li class="nav-item">
    ...
    <div class="container-fluid mt-5" style="background-color: #010035; margin-top: auto;">
                ...
                <div class="d-flex justify-content-center">
                    <div>
                        <p class="text-white mt-4 ms-4"
                            style="font-size: 25px; font-family: 'Cormorant Garamond', serif; font-weight: 900;">Useful
                            Links</p>
                        <ul style="list-style-type: none;" class="link-list">
                            ...
                            <li class="text-white mb-4"> > <a href="lecturer.html">Faculty</a></li>
                            <li class="text-white mb-4"> > <a href="events.html">Events</a></li>
                            <li class="text-white mb-4"> > <a href="faq.html">FAQ</a></li>
                            <li class="text-white mb-4"> > <a href="contact.html">Contact</a></li>
                        </ul>
                    </div>
        ...
        <hr>
        <div class="container-fluid">
            <p class="text-white text-center pb-3 m-0">Copyright &copy; 2023 by BigTech International. All rights
                reserved!</p>
        </div>
    </div>
