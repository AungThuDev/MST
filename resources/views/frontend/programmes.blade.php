...
@section('style')
    @if ($programmes_banner && $programmePage)
        <style>
            .programmes-banner {
                ...
                @if (count($category->programmes) > 0)
                    ...
                    @foreach ($category->programmes as $programme)
                        <div>
                            ...
                            <p class="programme-text">{{ $programme->duration }}<a href="{{ $programme->link }}"
                                    target="_blank" class="btn btn-primary float-end"
                                    style="background-color: #36348E;">Course Info</a>
                            </p>
                    ...
                    <div class="item" style="height: 400px;">
                        <div class="card p-3 rounded" style="height: 390px;">
                            <div class="d-flex justify-content-center align-items-center" style="height: 110px;"><img
                                    src="{{ asset('/partner/' . $partner->image) }}" style="width: 250px; height: 80px;"
                                    class="card-img-top" alt="partner image"></div>
                            <div class="card-body">
            ...
            @foreach ($awards as $award)
                <div
                    ...
                    <div class="{{ $loop->even ? 'order-md-first order-lg-first' : 'order-md-last order-lg-last' }}">
                        <img src="{{ asset('/award/' . $award->image) }}" class="img-fluid rounded" alt="award image"
                            style="width: 800px;">
                    </div>
                    <div
                        class="px-3 mt-3 mt-md-0 mt-lg-0 {{ $loop->even ? 'order-md-last order-lg-last' : 'order-md-first order-lg-first' }}">
                        <h4>
