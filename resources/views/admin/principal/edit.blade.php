    ...
    <section>
        ...
        <form method="POST" action="{{ route('admin.principal.update', $principal->id) }}" enctype="multipart/form-data">
            ...
            <div>
                ...
                <input class="form-control" id="name" type="text" name="name" value="{{ old('name') ?? $principal->name }}">
                @error('name')
            ...
            <div class="mt-4 d-flex flex-column">
                ...
                <img src="{{ asset('/principal/' . $principal->home_image) }}" alt="Principal Home Page Image" style="width: 200px;">
            ...
            <div class="mt-4 d-flex flex-column">
                ...
                <img src="{{ asset('/principal/' . $principal->faculty_image) }}" alt="Principal Faculty Page Image" style="width: 200px;">
