            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea name="about_text" class="form-control">{{ old('about_text') }}</textarea>
                        @error('about_text')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ old('progress_one_percent') }}" class="form-control"
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('progress_two') }}" class="form-control"
                            name="progress_two">
                        @error('progress_two')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ old('progress_two_percent') }}" class="form-control"
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{ old('progress_three') }}" class="form-control"
                            name="progress_three">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="number" value="{{ old('progress_three_percent') }}" class="form-control"
