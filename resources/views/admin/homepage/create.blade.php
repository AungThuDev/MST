            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="about_title" type="text" value="{{ old('about_title') }}"
                               class="form-control"
                               name="about_title">
                        @error('about_title')
                        <span class="badge badge-danger">{{ $message }}</span>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea id="about_text" name="about_text"
                                  class="form-control"
                                  rows="5">{{ old('about_text') }}</textarea>
                        @error('about_text')
                        <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="eval_title" type="text" value="{{ old('eval_title') }}"
                               class="form-control"
                               name="eval_title">
                        @error('eval_title')
                        <span class="badge badge-danger">{{ $message }}</span>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea id="eval_text" name="eval_text"
                                  class="form-control">{{ old('eval_text') }}</textarea>
                        @error('eval_text')
                        <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress1" type="text" value="{{ old('progress1') }}"
                               class="form-control"
                               name="progress1">
                        @error('progress1')
                        <span class="badge badge-danger">{{ $message }}</span>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress2" type="text" value="{{ old('progress2') }}"
                               class="form-control"
                               name="progress2">
                        @error('progress2')
                        <span class="badge badge-danger">{{ $message }}</span>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress3" type="text" value="{{ old('progress3') }}"
                               class="form-control"
                               name="progress3">
                        @error('progress3')
                        <span class="badge badge-danger">{{ $message }}</span>
