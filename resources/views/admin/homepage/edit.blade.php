            ...
            <div class="row">
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$homepage->vision}}" class="form-control" name="vision">
                        @error('vision')
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" value="{{$homepage->mission}}" class="form-control" name="mission">
                        @error('mission')
                            <span class="badge badge-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$homepage->about_text}}" name="about_text">
                        @error('about_text')
                            <span class="badge badge-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <img style="width: 100px" class="img-thumbnail" src="{{url('/images/' . $homepage->about_image1)}}" alt="">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <img style="width: 100px" class="img-thumbnail" src="{{url('/images/' . $homepage->about_image2)}}" alt="">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <img style="width: 100px" class="img-thumbnail" src="{{url('/images/' . $homepage->journey_image1)}}" alt="">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <img style="width: 100px" class="img-thumbnail" src="{{url('/images/' . $homepage->journey_image2)}}" alt="">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <img style="width: 100px" class="img-thumbnail" src="{{url('/images/' . $homepage->eval_image)}}" alt="">
                        @error('eval_image')
                            <span class="badge badge-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$homepage->prograss1}}" name="progress_one">
                        @error('progress_one')
                            <span class="badge badge-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{$homepage->prograss1_percent}}" name="progress_one_percent">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$homepage->prograss2}}" name="progress_two">
                        @error('progress_two')
                            <span class="badge badge-danger">{{$message}}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{$homepage->prograss2_percent}}" name="progress_two_percent">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" value="{{$homepage->prograss3}}" name="progress_three">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input type="number" class="form-control" value="{{$homepage->prograss3_percent}}" name="progress_three_percent">
