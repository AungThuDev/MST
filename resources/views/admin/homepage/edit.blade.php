            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea id="vision" name="vision" class="form-control" rows="4">{{ old('vision') ?? $homepage->vision }}</textarea>
                        @error('vision')
                ...
                <div class="col-6">
                    <div class="form-group">
                        <label for="mission">Mission<span style="color: red">*</span> <span class="text-gray">(Maximum 300
                                characters)</span></label>
                        <textarea id="mission" name="mission" class="form-control" rows="4">{{ old('mission') ?? $homepage->mission }}</textarea>
                        @error('mission')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <textarea id="about_text" name="about_text" class="form-control" rows="5">{{ old('about_text') ?? $homepage->about_text }}</textarea>
                        @error('about_text')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="eval_title" type="text" value="{{ old('eval_title') ?? $homepage->eval_title }}"
                            class="form-control" name="eval_title">
                        @error('eval_title')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-12">
                    <div class="form-group">
                        ...
                        <textarea id="eval_text" name="eval_text" class="form-control">{{ old('eval_text') ?? $homepage->eval_text }}</textarea>
                        @error('eval_text')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress1" type="text" value="{{ old('progress1') ?? $homepage->progress1 }}"
                            class="form-control" name="progress1">
                        @error('progress1')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress1_percent" type="number"
                            value="{{ old('progress1_percent') ?? $homepage->progress1_percent }}" class="form-control"
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress2" type="text" value="{{ old('progress2') ?? $homepage->progress2 }}"
                            class="form-control" name="progress2">
                        @error('progress2')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress2_percent" type="number"
                            value="{{ old('progress2_percent') ?? $homepage->progress2_percent }}" class="form-control"
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress3" type="text" value="{{ old('progress3') ?? $homepage->progress3 }}"
                            class="form-control" name="progress3">
                        @error('progress3')
                            <span class="badge badge-danger">{{ $message }}</span>
                        @enderror
                    </div>
                ...
                <div class="col-6">
                    <div class="form-group">
                        ...
                        <input id="progress3_percent" type="number"
                            value="{{ old('progress3_percent') ?? $homepage->progress3_percent }}" class="form-control"
