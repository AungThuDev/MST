...
class HomePageController extends Controller
{
    ...
    public function store(Request $request)
    {
        $validated = $request->validate([
            ...
            'about_text' => 'required',
            'about_image1' => 'required|image|mimes:png,jpg,jpeg,webp',
            'about_image2' => 'required|image|mimes:png,jpg,jpeg,webp',
            'journey_image1' => 'required|image|mimes:png,jpg,jpeg,webp',
            'journey_image2' => 'required|image|mimes:png,jpg,jpeg,webp',
            'journey_title1' => 'required',
            'journey_title2' => 'required',
            'journey_text1' => 'required',
            'journey_text2' => 'required',
            'eval_title' => 'required',
            'eval_image' => 'required|image|mimes:png,jpg,jpeg,webp',
            'eval_text' => 'required',
            'progress1' => 'required',
